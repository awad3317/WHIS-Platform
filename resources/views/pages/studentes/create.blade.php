                ...
                <div class="mb-8">
                    ...
                    <div x-data="{ imagePreview: null }" class="relative">
                        <label for="studentImage"
                            class="cursor-pointer flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 p-4 hover:border-blue-500 transition-colors duration-200 min-h-[120px] w-full">
                        ...
                        <div class="flex items-center space-x-3 mb-3 space-x-reverse">
                            ...
                            <div class="relative flex-1">
                                <label :for="'additionalFile_' + index"
                                    class="cursor-pointer flex items-center justify-between rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 hover:border-blue-500 transition-colors duration-200">
