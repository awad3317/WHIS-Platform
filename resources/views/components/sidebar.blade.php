                ...
                {{ trans('messages.User_Profile') }}
                       ...
                       <li>
                           <a href="#" @click.prevent="selected = (selected === 'Register' ? '':'Register')"
                               class="menu-item group"
                               :class="(selected === 'Register') || (page === 'formElements' || page === 'formLayout' ||
                                   page === 'proFormElements' || page === 'proFormLayout') ? 'menu-item-active' :
                               'menu-item-inactive'">
                               <svg :class="(selected === 'Register') || (page === 'formElements' || page === 'formLayout' ||
                       ...
                       <li>
                           <a href="#" @click.prevent="selected = (selected === 'RegisterEmployee' ? '':'RegisterEmployee')"
                               class="menu-item group"
                               :class="(selected === 'RegisterEmployee') || (page === 'formElements' || page === 'formLayout' ||
                                   page === 'proFormElements' || page === 'proFormLayout') ? 'menu-item-active' :
                               'menu-item-inactive'">
                               <svg :class="(selected === 'RegisterEmployee') || (page === 'formElements' || page === 'formLayout' ||
                                   page === 'proFormElements' || page === 'proFormLayout') ? 'menu-item-icon-active' :
                               'menu-item-icon-inactive'"
                                   width="24" height="24" viewBox="0 0 24 24" fill="none"
                                   xmlns="http://www.w3.org/2000/svg">
                               ...
                               <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">
                                ...
                                <div class="flex justify-end">
                                   <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                   :class="[(selected === 'RegisterEmployee') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive',
                                       sidebarToggle ? 'lg:hidden' : ''
                                   ]"
                                   width="20" height="20" viewBox="0 0 20 20" fill="none"
                                   xmlns="http://www.w3.org/2000/svg">
                       ...
                       {{-- <li>
                           <a href="#" @click.prevent="selected = (selected === 'Tables' ? '':'Tables')"
                               ...
                               <svg class="menu-item-arrow absolute  {{ app()->getLocale() == 'ar' ? 'left-2.5' : 'right-2.5' }} top-1/2 -translate-y-1/2 stroke-current"
