        ...
        <div class="mb-12">
            ...
            <div class="relative mb-6">
                <input type="text" wire:model.live="fatherQuery"
                    ...
                    placeholder="{{ trans('student.search_father') }}">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mt-6">
                ...
                <div>
                    <label class="block mb-1 text-xs text-gray-500">{{ trans('student.father_name_ar') }}</label>
                    <input type="text" wire:model="father_name_ar" name="father_name_ar"
                        class="h-12 w-full rounded-xl border px-4 text-sm">
                </div>

                <div>
                    <label class="block mb-1 text-xs text-gray-500">{{ trans('student.father_name_en') }}</label>
                    <input type="text" wire:model="father_name_en" name="father_name_en"
                        class="h-12 w-full rounded-xl border px-4 text-sm">
                </div>

                <div>
                    <label class="block mb-1 text-xs text-gray-500">{{ trans('student.father_national_id') }}</label>
                    <input type="text" wire:model="father_national_id" name="father_national_id"
                        class="h-12 w-full rounded-xl border px-4 text-sm">
                </div>

                <div>
                    <label class="block mb-1 text-xs text-gray-500">{{ trans('student.father_mobile') }}</label>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6">
        ...
        <div class="relative mb-6">
            <input type="text" wire:model.live="motherQuery"
                ...
                placeholder="{{ trans('student.search_mother') }}">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mt-6">
            ...
            <div>
                <label class="block mb-1 text-xs text-gray-500">{{ trans('student.mother_name_ar') }}</label>
                <input type="text" wire:model="mother_name_ar" name="mother_name_ar"
                    class="h-12 w-full rounded-xl border px-4 text-sm">
            </div>

            <div>
                <label class="block mb-1 text-xs text-gray-500">{{ trans('student.mother_name_en') }}</label>
                <input type="text" wire:model="mother_name_en" name="mother_name_en"
                    class="h-12 w-full rounded-xl border px-4 text-sm">
            </div>

            <div>
                <label class="block mb-1 text-xs text-gray-500">{{ trans('student.mother_national_id') }}</label>
                <input type="text" wire:model="mother_national_id" name="mother_national_id"
                    class="h-12 w-full rounded-xl border px-4 text-sm">
            </div>

            <div>
                <label class="block mb-1 text-xs text-gray-500">{{ trans('student.mother_mobile') }}</label>
