                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    <li>
                        <a href="{{ url('Dashboard') }}" @click.window.location.href='{{ url('Dashboard') }}'
                            class="menu-item group" :class="(selected === 'Dashboard') ?
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Register' ? '':'Register')"
                            class="menu-item group" :class="(selected === 'Register') || (page === 'Student Register' || page === 'Student List') ?
                               'menu-item-active' :
                               'menu-item-inactive'">
                            ...
                            <div :class="app()->getLocale() == 'en' ? 'absolute right-0' : 'absolute left-0'">
                                <svg :class="[(selected === 'Register') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive',
                                       sidebarToggle ? 'lg:hidden' : ''
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="{{ route('students.index') }}" class="menu-dropdown-item group" :class="page === 'Student List' ? 'menu-dropdown-item-active' :
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{route('students.create')}}" class="menu-dropdown-item group" :class="page === 'Student Register' ? 'menu-dropdown-item-active' :
                                               'menu-dropdown-item-inactive'">
