            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    @if (Auth::user()->hasPermission('view_students'))
                        <li>
                            <a href="{{ route('students.index') }}" class="menu-item group"
                                :class="window.location.href.includes('{{ route('students.index') }}') ?
                                    'menu-item-active' :
                                    'menu-item-inactive'">
                                <!-- ICON -->
                                <svg :class="window.location.href.includes('{{ route('students.index') }}') ?
                                ...
                                <div class="flex justify-end items-center">
                                    <svg class="menu-item-arrow"
                                        :class="[
                                            (selected === 'Dashboard') ? 'menu-item-arrow-active' :
