                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    <li>
                        <a href="{{ route('dashboard.index') }}" class="menu-item group"
                            :class="window.location.href.includes('{{ route('dashboard.index') }}') ? 'menu-item-active' :
                                'menu-item-inactive'">
                    ...
                    @if (Auth::user()->hasPermission('view_students'))
                        <li>
                            <a href="#"
                                @click.prevent="selected = (selected === 'RegisterStudent' ? '':'RegisterStudent')"
                                class="menu-item group"
                                :class="(selected === 'RegisterStudent') || (page === 'formElements' ||
                                    page === 'formLayout' ||
                                    page === 'proFormElements' || page === 'proFormLayout') ? 'menu-item-active' :
                                'menu-item-inactive'">
                                <svg :class="(selected === 'RegisterStudent') || (page === 'formElements' ||
                                    page === 'formLayout' ||
                                ...
                                <div class="flex justify-end">
                                    ...
                                    <div class="app()->getLocale() == 'ar' ? 'absolute right-0' : 'absolute left-0'">
                                        <svg class=" absolute  top-1/2 -translate-y-1/2 stroke-current"
                                            :class="[(selected === 'RegisterStudent') ? 'menu-item-arrow-active' :
                            ...
                            <div class="overflow-hidden transform translate"
                                :class="(selected === 'RegisterStudent') ? 'block' : 'hidden'">
