...
<configuration>
    ...
    public function uploadFile(Student $student, UploadedFile $file, string $fileType, string $name, $uploadedBy,?string $description = null): student_file
    {
    ...
    private function validateFileType(UploadedFile $file, string $fileType): void
    {
        $allowedMimeTypes = [
            ...
            'other' => ['application/pdf', 'image/jpeg', 'image/png', 'text/plain', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'],
        ];
    ...
    public function downloadFile(student_file $studentFile)
    {
    ...
    public function getFileInfo(student_file $studentFile): array
    {
    ...
    public function deleteFile(student_file $studentFile): bool
    {
        try {
            if (Storage::disk($this->disk)->exists($studentFile->file_path)) {
    ...
    public function fileExists(student_file $studentFile): bool
    {
